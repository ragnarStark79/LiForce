/**
 * DashboardIcons - Modern SVG icons for dashboard components
 * Replaces emoji with professional, animatable icons
 */

// Heart icon - for donations/blood
...
// Document icon - for requests/records
export const DocumentIcon = ({ className = '', size = 24 }) => (
  <svg
    className={className}
    width={size}
    height={size}
...
// Users/People icon - for lives impacted/patients
...
// Chat/Message icon - for messages
...
// Checkmark icon - for approvals/success
...
// Clock icon - for pending/waiting
...
// Alert/Warning icon - for critical
...
// Droplet/Blood icon
export const DropletIcon = ({ className = '', size = 24 }) => (
  <svg
    className={className}
    width={size}
    height={size}
...
// Activity/Pulse icon
export const ActivityIcon = ({ className = '', size = 24 }) => (
  <svg
    className={className}
    width={size}
    height={size}
...
export const ServerIcon = ({ className = '', size = 24 }) => (
  <svg
    className={className}
    width={size}
    height={size}
